...
- <nav> : 메뉴/네비게이션
- <main> : 페이지의 핵심 콘텐츠 (로그인 폼, 글 본문, 상품 정보 등)
- <section> : 의미 있는 구역
...
17. height, min-height?
- height: 100vh(화면 전체 높이, 스크롤 없이 보이는 영역의 전체) = "딱 화면 높이 만큼만"
- min-height: 100vh = "최소 그 높이는 되어야 함", 콘텐츠가 더 많으면 자연스럽게 늘어남(스크롤)
  - min-height가 아닌 height를 사용하는 상황: "이 크기에서 절대 벗어나면 안 돼"
